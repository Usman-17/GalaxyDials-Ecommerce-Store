...
const PlaceOrderPage = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Place Your Order | Jemzy</title>
        <meta
          name="description"
          content="Place your order securely on Jemzy. Provide your delivery information and confirm your Cash on Delivery payment method."
        />
        <meta
          name="keywords"
          content="Jemzy, Place Order, Cash on Delivery, Online Checkout, Buy Online, Jemzy Store"
        />
        <link rel="canonical" href="https://www.jemzy.pk/place-order" />
      </Helmet>
      <form
