...
//                         <p className="w-52 sm:w-96 text-sm  sm:text-md leading-tight tracking-tight">
//                           {item?.title}
//                         </p>
...
//                     <div className="flex items-center gap-4 justify-between sm:justify-end mt-3 sm:mt-0">
//                       <input
                ...
                >
                  <div className="flex flex-col sm:flex-row sm:items-start gap-4">
                    <div className="flex items-start gap-4">
                      ...
                      />
                      <div>
                        <p className="font-semibold sm:font-medium sm:w-96 text-sm sm:text-base leading-tight">
                          {item?.title}
                        </p>
