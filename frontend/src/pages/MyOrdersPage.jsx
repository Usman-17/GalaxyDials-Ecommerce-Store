...
const MyOrdersPage = () => {
  ...
  return (
    <>
      <Helmet>
        <title>My Orders - Jemzy.pk | Cash on Delivery Orders</title>
        <meta
          name="description"
          content="View and manage your jewelry orders placed with Jemzy.pk. All orders are processed with Cash on Delivery. Track status and order details easily."
        />
        <meta
          name="keywords"
          content="Jemzy.pk orders, cash on delivery, jewelry order history, order tracking, my orders"
        />
        <link rel="canonical" href="https://www.jemzy.pk/my-orders" />
        <meta property="og:title" content="My Orders - Jemzy.pk" />
        <meta
          property="og:description"
          content="Track and manage your jewelry orders at Jemzy.pk. All purchases are Cash on Delivery for your convenience and security."
        />
        <meta property="og:url" content="https://www.jemzy.pk/my-orders" />
                ...
                <div className="flex items-start gap-6 text-sm flex-col">
                  {order.items.map((item, idx) => (
                    <div key={idx} className="flex gap-4">
                      ...
                      <div>
                        <p
                          className="sm:text-base font-medium w-full sm:w-96 truncate text-wrap"
                          style={{
                            display: "-webkit-box",
                            WebkitLineClamp: 2,
