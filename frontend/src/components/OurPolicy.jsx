...
const OurPolicy = () => {
  return (
    <div className="flex flex-col sm:flex-row justify-around gap-5 sm:gap-2 text-center py-10 sm:py-20 lg:px-20 text-xs sm:text-sm md:text-bas text-gray-700">
      <div>
